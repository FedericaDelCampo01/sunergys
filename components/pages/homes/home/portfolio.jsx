...
const Portfolio = () => {
    // Duplicar los elementos para tener 8 en total
                ...
                <div className="row al-end mb-60">
                    <div className="col-xl-8 lg-mb-25">
                        <div className="portfolio__one-title lg-t-center">
                            <span className="subtitle-one">Nuestros Proyectos</span>
                            <h2>Galería de Instalaciones</h2>
                        </div>
                    </div>
                    <div className="col-xl-4">
                        <div className="portfolio__one-btn t-right lg-t-center">
                            <Link className="btn-one" href="/portfolio/3-columns">Ver Todos los Proyectos</Link>
                        </div>
                    </div>
                </div>
            </div>
            <Swiper modules={[EffectFade, Autoplay]} {...slideControl} >
                {duplicatedPortfolioData?.map((data, id) => (
